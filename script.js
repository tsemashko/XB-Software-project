...
var table = {
    ...
    onClick: {
      ...
      rules:{
        ...
        rating: (value) => {return clearTags(value) !== "0" && clearTags(value).trim() !== "" && webix.rules.isNumber(value)}
    },
    columns: [
        {
          id: "id",
    ...
    rows:[
        header,
        {
            cols:[
                ...
                cells: [
                    {id: "Dashboard", cols: [{rows: [segmentedFilter, table]}, form]},
